...
% Title page
\title{\Huge\bfseries\sffamily SDE analysis}
\subtitle{\large A from first principles derivation for the GBM SDE solution and its discretization.}
...
\chapter{The Geometric Brownian Motion SDE}
...
\chapter{Strong and weak convergence formulations}
...
\section{Intuition behind the convergence orders}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../Assets/GBM_log_paths.png}
\caption{Analytical and Euler-Maruyama log\_returns}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{../Assets/EM_errors.png}
\caption{Weak and strong errors}
\end{figure}
...
\chapter{Application to modelling}

Due to various real world phenomenons being modellable as a constant drift with random fluctiations, the GBM SDE can be useful for predictions. In this case, it will be used to model population growth under uncertainty. The full code is in the \texttt{Convergence\_Test.ipynb} Jupyter notebook.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../Assets/Ethiopia_paths.png}
\caption{Simulated population growth for Ethiopia (10 year extrapolation)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{../Assets/Ethiopia_histogram.png}
\caption{Terminal population histogram for Ethiopia (10 year extrapolation)}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Ethiopia population estimations for coarse and fine time intervals}
